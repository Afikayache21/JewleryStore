...
export const ShopContextProvider = ({ children }) => {
    ...
    const [shopList, setShopList] = useState([
        ...
        content: 'A delicate embrace of metal, cradling the essence of affection within its curves.', price: 100, quantity: 10 , isEdit: false},
        ...
        content: 'A regal adornment, fit for royalty, sparkling with the majesty of a thousand dreams.', price: 200 , quantity: 10, isEdit: false},
        ...
        content: 'A luminous dance of light, captivating with every flicker, a beacon of brilliance on the finger.', price: 300 , quantity: 10, isEdit: false},
        ...
        content: 'A promise of dreams, the wishbone ring cradles hope in its graceful arc.', price: 400 , quantity: 10, isEdit: false},
        ...
        content: 'Unlocking secrets of the heart, the key necklace symbolizes the power of loves journey.', price: 500 , quantity: 10, isEdit: false},
        ...
        content: 'Guardian of fortune, the Hamsa necklace wards off evil with timeless elegance.', price: 600, quantity: 10, isEdit: false },
        ...
        content: 'Worn with pride, the hai necklace embodies the essence of lifes vitality and enduring spirit.', price: 700, quantity: 10, isEdit: false },
        ...
        content: 'A symphony of sparkle, the diamond necklace radiates timeless elegance.', price: 700, quantity: 10 , isEdit: false},
        ...
        content: 'The chain earrings dance with every movement, with a subtle touch of sophistication.', price: 200, quantity: 10, isEdit: false },
        ...
        content: 'Crystal earrings shimmer softly, adding a touch of elegance to every look.', price: 400, quantity: 10 , isEdit: false},
        ...
        content: 'Huggie earrings embrace the ear with subtle elegance, a delicate accent for everyday charm.', price: 300, quantity: 10 , isEdit: false},
        ...
        content: 'Tear earrings cascade with grace, capturing emotions in a shimmering descent.', price: 100, quantity: 10 , isEdit: false},
    ]);
